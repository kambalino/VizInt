window.VIZINT_VERSION = '$VER: #011';

window.VIZINT_HISTORY = [
  {
  ver: '#011',
  title: 'Auto: version bump to #002',
  bullets: [
    'Auto: version bump to #002',
    'Auto: version bump to #001',
    'Auto: version bump to #001',
    'Auto: version bump to #001',
    'Auto: version bump to #001',
    'Auto: version bump to #001',
    ...
    'Corrected escape codes',
    'fixed regex for safe escapes',
    'more auto-history fixes',
    'more auto-history fixes',
    'Auto: version bump to #001',
    'Auto: version bump to #001',
    'More fixes for version history',
    'more fixes to auto-bumping code',
    'Auto: version bump to #001',
  ...
  {
  ver: '#002',
  title: 'Auto: version bump to #001',
  bullets: [
    'Auto: version bump to #001',
    'Auto: version bump to #001',
    'Auto: version bump to #001',
  ...
  bullets: [
    ...
    'refactored geolocation code (attempted) fix for geolocation code',
    'Async loading to fix console',
    'refactored ipApiJSONP + fixing crash due to delayed lat/long',
    '* Updated gadget loading defaults * cleaned up redundancy in shared.js * cleaned up redundancy in registry.js',
    'Version/History updates',
    'Merge branch `main` of https://github.com/kambalino/VizInt',
    'implemented httpSafe helper function used Protocol safe (http/s) helper Actually included sharedlib',
    'Add GitHub Actions workflow for GitHub Pages deployment',
    'renamed portal to index.html',
    'Initial Publication of VizInt Portal (v #003)',
    'VizInt Portal #003 - Initial Check-in'
  ],
  status: 'Auto-generated'
},
  {
