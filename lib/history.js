window.VIZINT_VERSION = '$VER: #057';

window.VIZINT_HISTORY = [
  {
  ver: '#057',
  title: 'iqama-countdown: > Fixed appearance of countdown timer after 3isha for fajr, even after midnight.',
  bullets: [
    'iqama-countdown: > Fixed appearance of countdown timer after 3isha for fajr, even after midnight.',
    'time-to-poi:',
    'Auto: version bump to #056'
  ],
  status: 'Auto-generated'
},
  {
  ver: '#056',
  title: 'Iqama-countdown: > Added adhan + iqama for all prayer times > Added progress bar > Added %age time left > Changed time left to be in hh:mm instead of just minutes',
  bullets: [
    'Iqama-countdown: > Added adhan + iqama for all prayer times > Added progress bar > Added %age time left > Changed time left to be in hh:mm instead of just minutes',
    'Auto: version bump to #055'
  ],
  status: 'Auto-generated'
},
  {
