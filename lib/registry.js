...
(function () {
  window.REGISTRY = {
    GADGETS: [
	  ...
	  { id:'time-to-poi',		singleton:false, path:'./gadgets/time-to-poi.js',     label:'Time to POI',           defaultEnabled:false, iconEmoji:'📍', iconBorder:'var(--chronus)' },
	  { id:'iqama-countdown',	singleton:false, path:'./gadgets/iqama-countdown.js', label:'Masjid Iqama Countdown', defaultEnabled:false, iconEmoji:'🕌', iconBorder:'var(--chronus)' }
