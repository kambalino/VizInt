...
(function () {
  ...
  window.REGISTRY = {
		GADGETS: [
			...
			{ id: 'helloworld', 		path: './gadgets/helloworld.js', label: 'Hello World', defaultEnabled: false },
			{ id: 'chronus-dev',		path: './gadgets/chronus-dev.js',   label: 'Chronus Timer',    defaultEnabled: false },
			{ id: 'chronus-core',		path: './gadgets/chronus-core.js', label: 'Chronus Core', defaultEnabled: false },
			{ id: 'prayertimes-chronus', path: './gadgets/prayertimes-chronus.js', label: 'Prayer Times (Chronus)', defaultEnabled: false },
