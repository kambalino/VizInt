...
(function () {
  window.REGISTRY = {
    GADGETS: [
      ...
      { id:'embed_dd0k',		singleton:false, path:'./gadgets/embed_dd0k.js',		label:'DD0K Embed',			defaultEnabled:true,  iconEmoji:'🎾' },
	  ...
	  { id:'flashcards',		singleton:true, path:'./gadgets/flashcards.js',       label:'Flash Cards',       defaultEnabled:false, iconEmoji:'🃏', iconBorder:'var(--chronus)' },
