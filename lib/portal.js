...
(async function () {
	...
	async function mountGadget(gadgetId, ctx, dock) {
		...
		const descriptor = {
			...
			showSettingsGear: false,     // refined once manifest is known
		...
		const chromeCtx = {
			...
			// Settings affordance – wired once manifest/API are known.
		...
		// Refine supportsSettings/showSettingsGear from manifest (if any)
		...
		descriptor.showSettingsGear = !!descriptor.supportsSettings;
